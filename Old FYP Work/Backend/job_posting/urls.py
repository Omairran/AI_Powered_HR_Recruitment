...
from .views import JobPostingView,JobPostDetailView,JobPostListView,JobApplicationView,JobPostDetailPublic,JobPostingWithApplicantsView,ApplicantsView,ApplicantDetailView,CandidateAppliedJobsView,SortedApplicantsView,CurrentCandidateProfile
from .views import get_application_status,download_frames_as_zip
urlpatterns = [
